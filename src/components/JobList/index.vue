        ...
        <template slot="items" scope="props">
          <td>
            <v-edit-dialog @open="props.item._name = props.item.name" @cancel="props.item.name = props.item._name || props.item.name" lazy> {{ props.item.name }}
              <v-text-field slot="input" label="Edit" v-bind:value="props.item.name" v-on:change="e => props.item.name = e.target.value" single-line counter="counter"></v-text-field>
            </v-edit-dialog>
          </td>
          ...
          <td>
            <v-edit-dialog class="text-xs-right" @open="props.item._iron = props.item.iron" @cancel="props.item.iron = props.item._iron || props.item.iron" large lazy>
              ...
              <v-text-field slot="input" label="Edit" v-model="props.item.iron" single-line counter autofocus></v-text-field>
            </v-edit-dialog>
          </td>
        </template>
